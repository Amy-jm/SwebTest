...
;+
;                  If $iIndex is 每1, the entire ListBox is searched from the beginning.
...
;                  |每1          - Retrieve the height of the selection field
...
; Author ........: Gary Frost (gafrost)
; Modified.......:
; Remarks .......: If the $iIndex parameter is 每1, the string is added to the end of the list.
;+
...
;+
;                  If $iIndex is 每1, the entire list is searched from the beginning.
...
; Author ........: Gary Frost (gafrost)
; Modified.......:
; Remarks .......: If $iIndex is 每1, any current selection in the list is removed and the edit control is cleared.
;+
;                  If $iIndex is greater than the number of items in the list or if $iIndex is 每1, the return value
...
;                  If $iStop is 每1, all text from the starting position to the last character in the edit control is selected.
;+
...
;                  |每1          - Set the height of the selection field
