...
import com.yeastar.swebtest.pobject.Settings.PBX.CallControl.InboundRoutes.*;
...
public class TimeCondition extends SwebDriver {
    ...
    @Test
    public void B1_addTimeCondition1() throws InterruptedException {
        ...
        Reporter.infoExec(" 添加时间条件Q_ABC: 00:00~01:00"); //执行操作
        m_callcontrol.addTimeContion("Q_ABC","00:00","01:00",false,"all");
        Reporter.infoExec(" 编辑Q_ABC，新增10个Time，勾选高级设置，All Month,All Day");
        gridClick(timeConditions.grid,Integer.parseInt(String.valueOf(gridFindRowByColumn(timeConditions.grid,timeConditions.gridcolumn_Name,"Q_ABC",sort_ascendingOrder))),timeConditions.gridEdit);
        for (int i=1;i<11;i++) {
    ...
    @Test
    public void B1_addTimeCondition2() throws InterruptedException {
    ...
    @Test
    public void B1_addTimeCondition3() throws InterruptedException {
    ...
    @Test
    public void B1_addTimeCondition4() throws InterruptedException {
    ...
    @Test
    public void B1_addTimeCondition5() throws InterruptedException {
    ...
    @Test
    public void B1_addTimeCondition6() throws InterruptedException {
    ...
    @Test
    public void B1_addTimeCondition7() throws InterruptedException {
    ...
    @Test
    public void B2_addHoliday() throws InterruptedException {
    ...
    @Test
    public void B3_addOutRoute1() throws InterruptedException {
        closeSetting();
        pageDeskTop.taskBar_Main.click();
        pageDeskTop.settingShortcut.click();
        settings.callControl_panel.click();
        ...
        ys_waitingTime(3000);
//        勾选time condition
        $$("#st-or-timecondition span").findBy(text("Q_ABC")).click();
...
//        保存编辑页面
    ...
    @Test
    public void B3_addOutRoute2() throws InterruptedException {
...
//        保存编辑页面
    ...
    @Test
    public void B3_addOutRoute3() throws InterruptedException {
...
//        保存编辑页面
    ...
    @Test
    public void B3_addOutRoute4() throws InterruptedException {
...
//        保存编辑页面
    ...
    @Test
    public void B3_addOutRoute5() throws InterruptedException {
...
//        保存编辑页面
    ...
    @Test
    public void B3_addOutRoute6() throws InterruptedException {
...
//        保存编辑页面
    ...
    @Test
    public void B3_addOutRoute7() throws InterruptedException {
...
//        保存编辑页面
    ...
    public void B4_editInRoute(){
        ...
        add_inbound_route.addTimeCondition.click();
        ys_waitingTime(1000);
        add_inbound_route.SetTimeConditionTableviewDestition(1,1,"Q_ABC");
...
//    验证第一个TimeCondition——Q_ABC
    @Test
    public void C1_FeatureCode(){
//        30.6.0.X
//        Reporter.infoExec(" 分机1000拨打特征码*801强制启用工作时间_Q_ABC"); //执行操作
//        pjsip.Pj_Make_Call_Auto_Answer(1000,"*801",DEVICE_IP_LAN,false);
//        30.7.0.X
        Reporter.infoExec(" 分机1000拨打特征码*802强制启用工作时间_Q_ABC"); //执行操作
    ...
    public void C3_makeCall_Out(){
        ...
        if (getExtensionStatus(1000, TALKING, 8) == TALKING) {
            ...
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"C3_makeCall_Out()分机1000.jpg");
            Reporter.sendReport("link","Error: " + "C3_makeCall_Out()调试", SCREENSHOT_PATH +"C3_makeCall_Out()分机1000.jpg");
            Reporter.error(" 预期分机1000状态为TALKING，实际状态为"+getExtensionStatus(1000, TALKING, 8));
        }
        pjsip.Pj_Hangup_All();
//        m_extension.checkCDR("1000 <1000>","922000","Answered"," ",SPS,communication_outRoute);
...
//        那这里就加一个cdr的star和end的提示，如果有弹窗，则点击弹窗后继续
    ...
    public void C4_makeCall_In(){
        ...
        if (getExtensionStatus(1000, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"C4_makeCall_In()分机1000.jpg");
            Reporter.sendReport("link","Error: " + "C4_makeCall_In()分机1000调试", SCREENSHOT_PATH +"C4_makeCall_In()分机1000.jpg");
            Reporter.error(" 预期分机1000状态为TALKING，实际状态为"+getExtensionStatus(1000, TALKING, 8));
        }
        pjsip.Pj_Hangup_All();
//        m_extension.checkCDR("2001 <2001>","1000 <1000>","Answered",SPS," ",communication_inbound);
    ...
    public void C7_makeCall_In(){
        ...
        if (getExtensionStatus(1000, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"C7_makeCall_In()分机1000.jpg");
            Reporter.sendReport("link","Error: " + "C7_makeCall_In()调试", SCREENSHOT_PATH +"C7_makeCall_In()分机1000.jpg");
            Reporter.error(" 预期分机1000状态为TALKING，实际状态为"+getExtensionStatus(1000, TALKING, 8));
        }
        pjsip.Pj_Hangup_All();
        pageDeskTop.taskBar_Main.click();
...
//    验证holiday的week2
    ...
    public void C8_FeatureCode(){
        ...
        if (getExtensionStatus(1000, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"C8_FeatureCode()分机1000.jpg");
            Reporter.sendReport("link","Error: " + "C8_FeatureCode()调试", SCREENSHOT_PATH +"C8_FeatureCode()分机1000.jpg");
            Reporter.error(" 预期分机1000状态为TALKING，实际状态为"+getExtensionStatus(1000, TALKING, 8));
        }
        ys_waitingTime(5000);
        pjsip.Pj_Hangup_All();
    ...
    public void C9_makeCall_In(){
        ...
        if (getExtensionStatus(2001, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"C9_makeCall_In()分机2001.jpg");
            Reporter.sendReport("link","Error: " + "C9_makeCall_In()调试", SCREENSHOT_PATH +"C9_makeCall_In()分机2001.jpg");
...
//        30.7.0.X
        ...
        if (getExtensionStatus(1000, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"D1_setSystemTime1_FeatureCode()分机1000.jpg");
            Reporter.sendReport("link","Error: " + "D1_setSystemTime1_FeatureCode()调试", SCREENSHOT_PATH +"D1_setSystemTime1_FeatureCode()分机1000.jpg");
            Reporter.error(" 预期分机1000状态为TALKING，实际状态为"+getExtensionStatus(1000, TALKING, 8));
        }
        ys_waitingTime(5000);
        pjsip.Pj_Hangup_All();
    ...
    public void D2_makeCall_Out(){
        ...
        if (getExtensionStatus(1000, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"D2_makeCall_Out()分机1000.jpg");
            Reporter.sendReport("link","Error: " + "D2_makeCall_Out()调试", SCREENSHOT_PATH +"D2_makeCall_Out()分机1000.jpg");
            Reporter.error(" 预期分机1000状态为TALKING，实际状态为"+getExtensionStatus(1000, TALKING, 8));
        }
        pjsip.Pj_Hangup_All();
//        m_extension.checkCDR("1000 <1000>","922000","Answered"," ",SPS,communication_outRoute);
    ...
    public void D3_makeCall_In(){
        ...
        if (getExtensionStatus(1000, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"D3_makeCall_In()分机1000.jpg");
            Reporter.sendReport("link","Error: " + "D3_makeCall_In()调试", SCREENSHOT_PATH +"D3_makeCall_In()分机1000.jpg");
            Reporter.error(" 预期分机1000状态为TALKING，实际状态为"+getExtensionStatus(1000, TALKING, 8));
        }
        pjsip.Pj_Hangup_All();
//        m_extension.checkCDR("2001 <2001>","1000 <1000>","Answered",SPS," ",communication_inbound);
    ...
    public void D4_deleteTime(){
        ...
        time_Conditions.timeConditions.click();
        timeConditions.timeConditions.click();
        Reporter.infoExec("删除TimeCondition_Q_ABC的Time");
        int row = Integer.parseInt(String.valueOf(gridFindRowByColumn(timeConditions.grid,timeConditions.gridcolumn_Name,"Q_ABC",sort_ascendingOrder)));
    ...
    public void D5_makeCall_Out(){
        ...
        if (getExtensionStatus(1000, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"D5_makeCall_Out()分机1000.jpg");
            Reporter.sendReport("link","Error: " + "D5_makeCall_Out()调试", SCREENSHOT_PATH +"D5_makeCall_Out()分机1000.jpg");
            Reporter.error(" 预期分机1000状态为TALKING，实际状态为"+getExtensionStatus(1000, TALKING, 8));
        }
        pjsip.Pj_Hangup_All();
//        m_extension.checkCDR("1000 <1000>","922000","Answered"," ",SPS,communication_outRoute);
    ...
    public void D6_makeCall_In(){
        ...
        if (getExtensionStatus(1000, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"D6_makeCall_In()分机1000.jpg");
            Reporter.sendReport("link","Error: " + "D6_makeCall_In()调试", SCREENSHOT_PATH +"D6_makeCall_In()分机1000.jpg");
            Reporter.error(" 预期分机1000状态为TALKING，实际状态为"+getExtensionStatus(1000, TALKING, 8));
        }
        pjsip.Pj_Hangup_All();
//        m_extension.checkCDR("2001 <2001>","1000 <1000>","Answered",SPS," ",communication_inbound);
    ...
    public void D9_makeCall_In(){
        ...
        if (getExtensionStatus(1000, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"D9_makeCall_In()分机1000.jpg");
            Reporter.sendReport("link","Error: " + "D9_makeCall_In()调试", SCREENSHOT_PATH +"D9_makeCall_In()分机1000.jpg");
            Reporter.error(" 预期分机1000状态为TALKING，实际状态为"+getExtensionStatus(1000, TALKING, 8));
        }
        pjsip.Pj_Hangup_All();
        pageDeskTop.taskBar_Main.click();
...
//        30.7.0.X
        ...
        if (getExtensionStatus(1000, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"E1_FeatureCode()分机1000.jpg");
            Reporter.sendReport("link","Error: " + "E1_FeatureCode()调试", SCREENSHOT_PATH +"E1_FeatureCode()分机1000.jpg");
            Reporter.error(" 预期分机1000状态为TALKING，实际状态为"+getExtensionStatus(1000, TALKING, 8));
        }
        ys_waitingTime(5000);
        pjsip.Pj_Hangup_All();
    ...
    public void E3_makeCall_Out(){
        ...
        if (getExtensionStatus(1100, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"E3_makeCall_Out()分机1100.jpg");
            Reporter.sendReport("link","Error: " + "E3_makeCall_Out()调试", SCREENSHOT_PATH +"E3_makeCall_Out()分机1100.jpg");
            Reporter.error(" 预期分机1100状态为TALKING，实际状态为"+getExtensionStatus(1100, TALKING, 8));
        }
        pjsip.Pj_Hangup_All();
//        m_extension.checkCDR("1100 <1100>","932000","Answered"," ",SPS,communication_outRoute);
    ...
    public void E4_makeCall_In(){
        ...
        if (getExtensionStatus(1100, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"E4_makeCall_In()分机1100.jpg");
            Reporter.sendReport("link","Error: " + "E4_makeCall_In()调试", SCREENSHOT_PATH +"E4_makeCall_In()分机1100.jpg");
...
//        m_extension.checkCDR("2001 <2001>","1100 <1100>","Answered",SPS," ",communication_inbound);
    ...
    public void E7_makeCall_In(){
        ...
        if (getExtensionStatus(1100, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"E7_makeCall_In()分机1100.jpg");
            Reporter.sendReport("link","Error: " + "E7_makeCall_In()调试", SCREENSHOT_PATH +"E7_makeCall_In()分机1100.jpg");
            Reporter.error(" 预期分机1100状态为TALKING，实际状态为"+getExtensionStatus(1100, TALKING, 8));
        }
        pjsip.Pj_Hangup_All();
//        m_extension.checkCDR("2001 <2001>","1100 <1100>","Answered",SPS," ",communication_inbound);
...
//    验证holiday的month
    ...
    public void E8_FeatureCode(){
        ...
        if (getExtensionStatus(1000, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"E8_FeatureCode()分机1000.jpg");
            Reporter.sendReport("link","Error: " + "E8_FeatureCode()调试", SCREENSHOT_PATH +"E8_FeatureCode()分机1000.jpg");
            Reporter.error(" 预期分机1000状态为TALKING，实际状态为"+getExtensionStatus(1000, TALKING, 8));
        }
        ys_waitingTime(5000);
        pjsip.Pj_Hangup_All();
    ...
    public void E9_makeCall_In(){
        ...
        if (getExtensionStatus(2001, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            pbxMonitor.conference.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"E9_makeCall_In()会议室.jpg");
            Reporter.sendReport("link","Error: " + "E9_makeCall_In()会议室", SCREENSHOT_PATH +"E9_makeCall_In()会议室.jpg");
            Reporter.error(" 预期分机2001状态为TALKING，实际状态为"+getExtensionStatus(2001, TALKING, 8));
        }
        pjsip.Pj_Hangup_All();
...
//        30.7.0.X
        ...
        if (getExtensionStatus(1000, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"F2_FeatureCode()分机1000.jpg");
            Reporter.sendReport("link","Error: " + "F2_FeatureCode()调试", SCREENSHOT_PATH +"F2_FeatureCode()分机1000.jpg");
            Reporter.error(" 预期分机1000状态为TALKING，实际状态为"+getExtensionStatus(1000, TALKING, 8));
        }
        ys_waitingTime(5000);
        pjsip.Pj_Hangup_All();
    ...
    public void F3_makeCall_Out(){
        ...
        if (getExtensionStatus(1101, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"F3_makeCall_Out()分机1101.jpg");
            Reporter.sendReport("link","Error: " + "F3_makeCall_Out()调试", SCREENSHOT_PATH +"F3_makeCall_Out()分机1101.jpg");
    ...
    public void F4_makeCall_In(){
        ...
        if (getExtensionStatus(2001, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"F4_makeCall_In()分机2001.jpg");
            Reporter.sendReport("link","Error: " + "F4_makeCall_In()调试", SCREENSHOT_PATH +"F4_makeCall_In()分机2001.jpg");
            Reporter.error(" 预期分机2001状态为TALKING，实际状态为"+getExtensionStatus(2001, TALKING, 8));
        }
        pjsip.Pj_Hangup_All();
//        m_extension.checkCDR("2001 <2001>","1101 <1101>","Answered",SPS," ",communication_inbound);
    ...
    public void F7_makeCall_In(){
        ...
        if (getExtensionStatus(2001, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"F7_makeCall_In()分机2001.jpg");
            Reporter.sendReport("link","Error: " + "F7_makeCall_In()调试", SCREENSHOT_PATH +"F7_makeCall_In()分机2001.jpg");
            Reporter.error(" 预期分机2001状态为TALKING，实际状态为"+getExtensionStatus(2001, TALKING, 8));
        }
        pjsip.Pj_Hangup_All();
        pageDeskTop.taskBar_Main.click();
...
//        30.7.0.X
        ...
        if (getExtensionStatus(1000, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"G1_FeatureCode()分机1000.jpg");
            Reporter.sendReport("link","Error: " + "G1_FeatureCode()调试", SCREENSHOT_PATH +"G1_FeatureCode()分机1000.jpg");
            Reporter.error(" 预期分机1000状态为TALKING，实际状态为"+getExtensionStatus(1000, TALKING, 8));
        }
        ys_waitingTime(5000);
        pjsip.Pj_Hangup_All();
    ...
    public void G3_makeCall_Out(){
        ...
        if (getExtensionStatus(1102, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"G3_makeCall_Out()分机1102.jpg");
            Reporter.sendReport("link","Error: " + "G3_makeCall_Out()调试", SCREENSHOT_PATH +"G3_makeCall_Out()分机1102.jpg");
            Reporter.error(" 预期分机1102状态为TALKING，实际状态为"+getExtensionStatus(1102, TALKING, 8));
        }
        pjsip.Pj_Hangup_All();
//        m_extension.checkCDR("1102 <1102>","952000","Answered"," ",SPS,communication_outRoute);
    ...
    public void G4_makeCall_In(){
        ...
        if (getExtensionStatus(2001, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"G4_makeCall_In()分机2001.jpg");
            Reporter.sendReport("link","Error: " + "G4_makeCall_In()调试", SCREENSHOT_PATH +"G4_makeCall_In()分机2001.jpg");
            Reporter.error(" 预期分机2001状态为TALKING，实际状态为"+getExtensionStatus(2001, TALKING, 8));
        }
        pjsip.Pj_Hangup_All();
//        m_extension.checkCDR("2001 <2001>","1102 <1102>","Answered",SPS," ",communication_inbound);
    ...
    public void G7_makeCall_In(){
        ...
        if (getExtensionStatus(2001, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"G7_makeCall_In()分机1102.jpg");
            Reporter.sendReport("link","Error: " + "G7_makeCall_In()调试", SCREENSHOT_PATH +"G7_makeCall_In()分机2001.jpg");
            Reporter.error(" 预期分机2001状态为TALKING，实际状态为"+getExtensionStatus(2001, TALKING, 8));
        }
        pjsip.Pj_Hangup_All();
        pageDeskTop.taskBar_Main.click();
    ...
    public void H2_makeCall_Out(){
        ...
        if (getExtensionStatus(1102, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"H2_makeCall_Out()分机1102.jpg");
            Reporter.sendReport("link","Error: " + "H2_makeCall_Out()调试", SCREENSHOT_PATH +"H2_makeCall_Out()分机1102.jpg");
            Reporter.error(" 预期分机1102状态为TALKING，实际状态为"+getExtensionStatus(1102, TALKING, 8));
        }
        pjsip.Pj_Hangup_All();
//        m_extension.checkCDR("1102 <1102>","952000","Answered"," ",SPS,communication_outRoute);
    ...
    public void H3_makeCall_In(){
        ...
        if (getExtensionStatus(2001, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"H3_makeCall_In()分机2001.jpg");
            Reporter.sendReport("link","Error: " + "H3_makeCall_In()调试", SCREENSHOT_PATH +"H3_makeCall_In()分机2001.jpg");
            Reporter.error(" 预期分机2001状态为TALKING，实际状态为"+getExtensionStatus(2001, TALKING, 8));
        }
        pjsip.Pj_Hangup_All();
        pageDeskTop.taskBar_Main.click();
    ...
    public void H6_makeCall_In(){
        ...
        if (getExtensionStatus(2001, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"H6_makeCall_In()分机2001.jpg");
            Reporter.sendReport("link","Error: " + "H6_makeCall_In()调试", SCREENSHOT_PATH +"H6_makeCall_In()分机2001.jpg");
            Reporter.error(" 预期分机2001状态为TALKING，实际状态为"+getExtensionStatus(2001, TALKING, 8));
        }
        pjsip.Pj_Hangup_All();
        pageDeskTop.taskBar_Main.click();
...
//    验证holiday——date
    ...
    public void H7_FeatureCode(){
        ...
        if (getExtensionStatus(1000, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"H7_FeatureCode()分机1000.jpg");
            Reporter.sendReport("link","Error: " + "H7_FeatureCode()分机1000", SCREENSHOT_PATH +"H7_FeatureCode()分机1000.jpg");
            Reporter.error(" 预期分机1000状态为TALKING，实际状态为"+getExtensionStatus(1000, TALKING, 8));
        }
        ys_waitingTime(5000);
        pjsip.Pj_Hangup_All();
    ...
    public void H8_makeCall_In(){
        ...
        if (getExtensionStatus(2001, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.pbxmonitorShortcut.click();
            pbxMonitor.conference.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"H8_makeCall_In()会议室.jpg");
            Reporter.sendReport("link","Error: " + "H8_makeCall_In()会议室", SCREENSHOT_PATH +"H8_makeCall_In()会议室.jpg");
            Reporter.error(" 预期分机2001状态为TALKING，实际状态为"+getExtensionStatus(2001, TALKING, 8));
        }
        pjsip.Pj_Hangup_All();
...
//    30.7.0.X
    ...
    if (getExtensionStatus(1000, TALKING, 8) == TALKING) {
        ...
        pageDeskTop.taskBar_Main.click();
        pageDeskTop.pbxmonitorShortcut.click();
        ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"I1_FeatureCode()分机1000.jpg");
        Reporter.sendReport("link","Error: " + "I1_FeatureCode()分机1000", SCREENSHOT_PATH +"I1_FeatureCode()分机1000.jpg");
        Reporter.error(" 预期分机1000状态为TALKING，实际状态为"+getExtensionStatus(1000, TALKING, 8));
    }
    ys_waitingTime(5000);
    pjsip.Pj_Hangup_All();
    ...
    public void I3_makeCall_Out(){
        ...
        if (getExtensionStatus(1103, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"I3_makeCall_Out()分机1103.jpg");
            Reporter.sendReport("link","Error: " + "I3_makeCall_Out()分机1103", SCREENSHOT_PATH +"I3_makeCall_Out()分机1103.jpg");
    ...
    public void I4_makeCall_In(){
        ...
        if (getExtensionStatus(2001, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"I4_makeCall_In()分机2001.jpg");
            Reporter.sendReport("link","Error: " + "I4_makeCall_In()分机2001", SCREENSHOT_PATH +"I4_makeCall_In()分机2001.jpg");
            Reporter.error(" 预期分机2001状态为TALKING，实际状态为"+getExtensionStatus(2001, TALKING, 8));
        }
        pjsip.Pj_Hangup_All();
        pageDeskTop.taskBar_Main.click();
    ...
    public void I7_makeCall_In(){
        ...
        if (getExtensionStatus(2001, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"I7_makeCall_In()分机2001.jpg");
            Reporter.sendReport("link","Error: " + "I7_makeCall_In()分机2001", SCREENSHOT_PATH +"I7_makeCall_In()分机2001.jpg");
            Reporter.error(" 预期分机2001状态为TALKING，实际状态为"+getExtensionStatus(2001, TALKING, 8));
        }
        pjsip.Pj_Hangup_All();
        pageDeskTop.taskBar_Main.click();
...
//        30.7.0.X
        ...
        if (getExtensionStatus(1000, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"J1_FeatureCode()分机1000.jpg");
            Reporter.sendReport("link","Error: " + "J1_FeatureCode()分机1000", SCREENSHOT_PATH +"J1_FeatureCode()分机1000.jpg");
            Reporter.error(" 预期分机1000状态为TALKING，实际状态为"+getExtensionStatus(1000, TALKING, 8));
        }
        ys_waitingTime(5000);
        pjsip.Pj_Hangup_All();
    ...
    public void J3_makeCall_Out(){
        ...
        if (getExtensionStatus(1104, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"J3_makeCall_Out()分机1104.jpg");
            Reporter.sendReport("link","Error: " + "J3_makeCall_Out()分机1104", SCREENSHOT_PATH +"J3_makeCall_Out()分机1104.jpg");
    ...
    public void J4_makeCall_In(){
        ...
        if (getExtensionStatus(2001, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"J3_makeCall_Out()分机2001.jpg");
            Reporter.sendReport("link","Error: " + "J3_makeCall_Out()分机2001", SCREENSHOT_PATH +"J3_makeCall_Out()分机2001.jpg");
            Reporter.error(" 预期分机2001状态为TALKING，实际状态为"+getExtensionStatus(2001, TALKING, 8));
        }
        pjsip.Pj_Hangup_All();
//        m_extension.checkCDR("2001 <2001>","xll <1104>","Answered",SPS," ",communication_inbound);
    ...
    public void J7_makeCall_In(){
        ...
        if (getExtensionStatus(2001, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"J7_makeCall_In()分机2001.jpg");
            Reporter.sendReport("link","Error: " + "J7_makeCall_In()分机2001", SCREENSHOT_PATH +"J7_makeCall_In()分机2001.jpg");
            Reporter.error(" 预期分机2001状态为TALKING，实际状态为"+getExtensionStatus(2001, TALKING, 8));
        }
        pjsip.Pj_Hangup_All();
//        m_extension.checkCDR("2001 <2001>","xll <1104>","Answered",SPS," ",communication_inbound);
    ...
    public void J8_FeatureCode(){
        ...
        if (getExtensionStatus(1000, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"J8_FeatureCode()分机1000.jpg");
            Reporter.sendReport("link","Error: " + "J8_FeatureCode()分机1000", SCREENSHOT_PATH +"J8_FeatureCode()分机1000.jpg");
            Reporter.error(" 预期分机1000状态为TALKING，实际状态为"+getExtensionStatus(1000, TALKING, 8));
        }
        ys_waitingTime(5000);
        pjsip.Pj_Hangup_All();
    ...
    public void J9_makeCall_In(){
        ...
        if (getExtensionStatus(2001, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.pbxmonitorShortcut.click();
            pbxMonitor.conference.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"J9_makeCall_In()会议室.jpg");
            Reporter.sendReport("link","Error: " + "J9_makeCall_In()会议室", SCREENSHOT_PATH +"J9_makeCall_In()会议室.jpg");
            Reporter.error(" 预期分机2001状态为TALKING，实际状态为"+getExtensionStatus(2001, TALKING, 8));
        }
        pjsip.Pj_Hangup_All();
...
//        30.7.0.X
        ...
        if (getExtensionStatus(1000, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"K1_FeatureCode()分机1000.jpg");
            Reporter.sendReport("link","Error: " + "K1_FeatureCode()分机1000", SCREENSHOT_PATH +"K1_FeatureCode()分机1000.jpg");
            Reporter.error(" 预期分机1000状态为TALKING，实际状态为"+getExtensionStatus(1000, TALKING, 8));
        }
        ys_waitingTime(5000);
        pjsip.Pj_Hangup_All();
    ...
    public void K3_makeCall_Out(){
        ...
        if (getExtensionStatus(1105, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"K3_makeCall_Out()分机1105.jpg");
            Reporter.sendReport("link","Error: " + "K3_makeCall_Out()分机1105", SCREENSHOT_PATH +"K3_makeCall_Out()分机1105.jpg");
    ...
    public void K4_makeCall_In(){
        ...
        if (getExtensionStatus(2001, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"K4_makeCall_In()分机2001.jpg");
            Reporter.sendReport("link","Error: " + "K4_makeCall_In()分机2001", SCREENSHOT_PATH +"K4_makeCall_In()分机2001.jpg");
            Reporter.error(" 预期分机2001状态为TALKING，实际状态为"+getExtensionStatus(2001, TALKING, 8));
        }
        pjsip.Pj_Hangup_All();
        pageDeskTop.taskBar_Main.click();
    ...
    public void K7_makeCall_In(){
        ...
        if (getExtensionStatus(2001, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"K7_makeCall_In()分机2001.jpg");
            Reporter.sendReport("link","Error: " + "K7_makeCall_In()分机2001", SCREENSHOT_PATH +"K7_makeCall_In()分机2001.jpg");
            Reporter.error(" 预期分机2001状态为TALKING，实际状态为"+getExtensionStatus(2001, TALKING, 8));
        }
        pjsip.Pj_Hangup_All();
        pageDeskTop.taskBar_Main.click();
    ...
    public void K8_FeatureCode(){
        ...
        if (getExtensionStatus(1000, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.taskBar_Main.click();
            pageDeskTop.pbxmonitorShortcut.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"K8_FeatureCode()分机1000.jpg");
            Reporter.sendReport("link","Error: " + "K8_FeatureCode()分机1000", SCREENSHOT_PATH +"K8_FeatureCode()分机1000.jpg");
            Reporter.error(" 预期分机1000状态为TALKING，实际状态为"+getExtensionStatus(1000, TALKING, 8));
        }
        ys_waitingTime(5000);
        pjsip.Pj_Hangup_All();
    ...
    public void K9_makeCall_In(){
        ...
        if (getExtensionStatus(2001, TALKING, 8) == TALKING) {
            ...
            pageDeskTop.pbxmonitorShortcut.click();
            pbxMonitor.conference.click();
            ScreenShot.takeScreenshotByAll(SCREENSHOT_PATH +"K9_makeCall_In()会议室.jpg");
            Reporter.sendReport("link","Error: " + "K9_makeCall_In()会议室", SCREENSHOT_PATH +"K9_makeCall_In()会议室.jpg");
            Reporter.error(" 预期分机2001状态为TALKING，实际状态为"+getExtensionStatus(2001, TALKING, 8));
        }
        pjsip.Pj_Hangup_All();
...
//        点击删除按钮
    ...
    @Test
    public void N_recovery1() throws InterruptedException {
//        新增默认的workday
//        添加默认的时间条件
