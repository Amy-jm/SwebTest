...
public class Conference extends SwebDriver {
    ...
    @Test
    public void C_CallIn() throws InterruptedException {
        Reporter.infoExec(" 1000拨打6401呼入到会议室6401"); //执行操作
        pjsip.Pj_Make_Call_No_Answer(1000,"6401",DEVICE_IP_LAN);
        ys_waitingTime(5000);
        YsAssert.assertEquals(String.valueOf(pbxMonitor.getInConference_num("Conference6401")),"1","预期会议室6401有1个成员");
        Reporter.infoExec(" 1100拨打6401呼入到会议室6401"); //执行操作
        pjsip.Pj_Make_Call_No_Answer(1100,"6401",DEVICE_IP_LAN);
        ys_waitingTime(5000);
        YsAssert.assertEquals(String.valueOf(pbxMonitor.getInConference_num("Conference6401")),"2","预期会议室6401有2个成员");
        Reporter.infoExec(" 1105拨打6401呼入到会议室6401"); //执行操作
        pjsip.Pj_Make_Call_No_Answer(1105,"6401",DEVICE_IP_LAN);
        ys_waitingTime(5000);
        YsAssert.assertEquals(String.valueOf(pbxMonitor.getInConference_num("Conference6401")),"3","预期会议室6401有3个成员");
    ...
    public void D_callin1() throws InterruptedException {
        ...
        ys_waitingTime(2000);
        YsAssert.assertEquals(String.valueOf(pbxMonitor.getInConference_num("Conference6402")),"1","预期会议室6402有1个成员");
    }
    ...
    public void D_callin2() throws InterruptedException {
        ...
        ys_waitingTime(2000);
        YsAssert.assertEquals(String.valueOf(pbxMonitor.getInConference_num("Conference6402")),"2","预期会议室6402有2个成员");
    }
    ...
    public void D_callin3() throws InterruptedException {
        ...
        ys_waitingTime(2000);
        YsAssert.assertEquals(String.valueOf(pbxMonitor.getInConference_num("Conference6402")),"3","预期会议室6402有3个成员");
    }
    ...
    public void D_callin4() throws InterruptedException {
        ...
        ys_waitingTime(2000);
        YsAssert.assertEquals(String.valueOf(pbxMonitor.getInConference_num("Conference6402")),"4","预期会议室6402有4个成员");
    }
    ...
    public void D_callin5() throws InterruptedException {
        ...
        ys_waitingTime(2000);
        YsAssert.assertEquals(getExtensionStatus(1100,HUNGUP,25),HUNGUP,"1100预期不会响铃");
    }

    @Test
    public void D_callin6() throws InterruptedException {
...
//    按#邀请
    ...
    public void E_invite() throws InterruptedException {
        ...
        ys_waitingTime(2000);
        pjsip.Pj_Hangup_All();
        m_extension.checkCDR("1100 <1100>","6401(from 1105)","Answered","","",communication_internal);
    }
