...
//        ivr.IVR.click();
    ...
    public void A2_AddIVR(HashMap<String, String> data) throws InterruptedException {
    ...
    @Test
    public void A3_EditKeys() throws InterruptedException {
        Reporter.infoExec(" 编辑IVR：Yeastar202，Prompt：选择prompt1，按2到Voicemail:1105，按3到RingGroup1，按4到Queue1，" +
                "按5到Conference1，按6到prompt1，按7到分机到IVR：*.*，按8到1106（fxs），按9到Dial by Name，按#到分机1100，" +
                "按*到分机1101，Timeout到分机1102，Invalid到prompt1"); //执行操作
        gridClick(ivr.grid,gridFindRowByColumn(ivr.grid,ivr.gridcolumn_Name,"Yeastar202",sort_ascendingOrder),ivr.gridEdit);
        ys_waitingMask();
    ...
    public void B_EditInRoute1() throws InterruptedException {
        Reporter.infoExec(" 编辑呼入路由InRoute1，到IVR：Yeastar202"); //执行操作
        ...
        comboboxSet(add_inbound_route.destination,"name","Yeastar202");
    ...
    @Test
    public void C0_backup() {
        Reporter.infoExec("备份IVR基础环境"); //执行操作
        backupEnviroment(getClass().getName());
    }
//    通话测试：各种外线呼入到IVR：Yeastar202
    @Test
    public void C1_sip_key0_1000() throws InterruptedException {
...
//        getExtensionStatus(1000,RING,10);
    ...
    @Test
    public void C2_sps_keyj_1100() throws InterruptedException {
...
//        getExtensionStatus(1100,RING,10);
    ...
    @Test
    public void C3_iax_key0_1000() throws InterruptedException {
...
//        getExtensionStatus(1000,RING,10);
    ...
    @Test
    public void C4_spx_key0_1000() throws InterruptedException {
        if(PRODUCT.equals(CLOUD_PBX)){
            return;
        }
...
//        getExtensionStatus(1000,RING,10);
    ...
    @Test
    public void C5_fxo_key0_1000() throws InterruptedException {
...
//        getExtensionStatus(1000,RING,10);
    ...
    @Test
    public void C6_bri_key0_1000() throws InterruptedException {
        if(PRODUCT.equals(CLOUD_PBX) || PRODUCT.equals(PC)){
            return;
        }
...
//        getExtensionStatus(1000,RING,10);
    ...
    @Test
    public void C7_e1_key0_1000() throws InterruptedException {
        if(PRODUCT.equals(CLOUD_PBX) || PRODUCT.equals(PC)){
            return;
        }
        if(E1.equals("null")){
...
//        getExtensionStatus(1000,RING,10);
    ...
    @Test
    public void C8_gsm_key0_1000() throws InterruptedException {
        if(PRODUCT.equals(CLOUD_PBX) || PRODUCT.equals(PC)){
            return;
        }
        if(GSM.equals("null")){
...
//    各种Key到各种目的地
    @Test
    public void D1_key1_callback() throws InterruptedException {
...
//        pjsip.Pj_Hangup_All();
    ...
    @Test
    public void D2_key2_voicemail1() throws InterruptedException {
    ...
    @Test
    public void D2_key2_voicemail2() throws InterruptedException {
    ...
    @Test
    public void D2_key2_voicemail3() throws InterruptedException {
    ...
    @Test
    public void D3_key3_ringgroup() throws InterruptedException {
        Reporter.infoExec(" 2000拨打99999通过sps外线呼入到IVR：6502，按3到RingGroup1,1100应答"); //执行操作
        pjsip.Pj_Make_Call_No_Answer(2000,"99999",DEVICE_ASSIST_2);
        ys_waitingTime(3000);
        pjsip.Pj_Send_Dtmf(2000,"3");
        YsAssert.assertEquals(getExtensionStatus(1000,RING,20),RING,"预期1000会响铃");
        YsAssert.assertEquals(getExtensionStatus(1100,RING,1),RING,"预期1100会响铃");
        YsAssert.assertEquals(getExtensionStatus(1105,RING,1),RING,"预期1105会响铃");
        pjsip.Pj_Answer_Call(1100,true);
        ys_waitingTime(5000);
        pjsip.Pj_Hangup_All();
    ...
    @Test
    public void D4_key4_queue() throws InterruptedException {
    ...
    @Test
    public void D5_key5_conference() throws InterruptedException {
...
//            ys_waitingTime(5000);
    ...
    @Test
    public void D7_key7_ivr() throws InterruptedException {
...
//    FXS分机
    @Test
    public void D8_key8_fxs() throws InterruptedException {
        if(PRODUCT.equals(CLOUD_PBX) || PRODUCT.equals(PC)){
            return;
        }
        if(FXS_1.equals("null")){
...
//    DialByName
    @Test
    public void D90_key9_dialbyname() throws InterruptedException {
    ...
    @Test
    public void D91_keyj_1100() throws InterruptedException {
        pjsip.Pj_Hangup_All();
        ...
        ys_waitingTime(2000);
        YsAssert.assertEquals(getExtensionStatus(1100,RING,10),RING,"预期1100为Ring状态");
    ...
    @Test
    public void D92_keyx_1101() throws InterruptedException {
        Reporter.infoExec(" 2000拨打99999通过sps外线呼入到IVR：6502，按*到分机1101"); //执行操作
        pjsip.Pj_Make_Call_No_Answer(2000,"99999",DEVICE_ASSIST_2);
        ys_waitingTime(5000);
        pjsip.Pj_Send_Dtmf(2000,"*");
        ys_waitingTime(3000);
        YsAssert.assertEquals(getExtensionStatus(1101,RING,20),RING,"预期1101为Ring状态");
    ...
    @Test
    public void D93_TimeOut() throws InterruptedException {
        Reporter.infoExec(" 2000拨打99999通过sps外线呼入到IVR：6502，Timeout到分机1102"); //执行操作
        pjsip.Pj_Make_Call_No_Answer(2000,"99999",DEVICE_ASSIST_2);
        ys_waitingTime(70000);
        YsAssert.assertEquals(getExtensionStatus(1102,RING,80),RING,"预期1102为Ring状态");
    ...
    public void D94_Invalid() {
        ...
        boolean showKeyWord= tcpSocket.getAsteriskInfo("record/prompt1");
        ys_waitingTime(3000);
        System.out.println("2000的通话状态1："+getExtensionStatus(2000,TALKING,1));
        pjsip.Pj_Send_Dtmf(2000,"A");
        boolean showKeyWord1= tcpSocket.getAsteriskInfo("record/prompt1");
        tcpSocket.closeTcpSocket();
        System.out.println("Q_IVRtoCustomCall TcpSocket return: "+showKeyWord1);
        if(showKeyWord1){
            ys_waitingTime(8000);
            Reporter.infoExec(" 2000按0到分机1000");
            System.out.println("2000的通话状态2："+getExtensionStatus(2000,TALKING,1));
            pjsip.Pj_Send_Dtmf(2000,"0");
//            getExtensionStatus(1000,RING,10);
            YsAssert.assertEquals(getExtensionStatus(1000,RING,20),RING,"预期1000会响铃");
            pjsip.Pj_Answer_Call(1000,false);
...
//    Dial Extension
    @Test
    public void E1_DialExtension_1103() throws InterruptedException {
...
//        getExtensionStatus(1103,RING,10);
        YsAssert.assertEquals(getExtensionStatus(1103,RING,20),RING,"预期1103会响铃");
    ...
    @Test
    public void E2_DialExtension_ringgroup1() throws InterruptedException {
...
//    Dial Extension 不启用时无法直播分机号
    @Test
    public void E3_DialExtension_disable() throws InterruptedException {
...
//    Dial Outbound Routes
    @Test
    public void F1_DialOut_sip() throws InterruptedException {
        Reporter.infoExec(" 2000拨打99999通过sps外线呼入到IVR：6502，拨打13001通过sip外线呼出"); //执行操作
        pjsip.Pj_Make_Call_No_Answer(2000,"99999",DEVICE_ASSIST_2);
        ys_waitingTime(3000);
        pjsip.Pj_Send_Dtmf(2000,"1","3","0","0","1","#");
        YsAssert.assertEquals(getExtensionStatus(3001,RING,20),RING,"预期3001为Ring状态");
    ...
    @Test
    public void F2_DialOut_sps() throws InterruptedException {
        ...
        YsAssert.assertEquals(getExtensionStatus(2000,RING,20),RING,"预期2000为Ring状态");
        pjsip.Pj_Answer_Call(2000,false);
        ys_waitingTime(5000);
        pjsip.Pj_Hangup_All();
    ...
    @Test
    public void F3_DialOut_iax() throws InterruptedException {
        if(PRODUCT.equals(CLOUD_PBX)){
            return;
        }
    ...
    @Test
    public void F4_DialOut_spx() throws InterruptedException {
        if(PRODUCT.equals(CLOUD_PBX)){
            return;
        }
    ...
    @Test
    public void F5_DialOut_fxo() throws InterruptedException {
        if (PRODUCT.equals(CLOUD_PBX) || PRODUCT.equals(PC)){
            return;
        }
    ...
    @Test
    public void F6_DialOut_bri() throws InterruptedException {
        if (PRODUCT.equals(CLOUD_PBX) || PRODUCT.equals(PC)){
            return;
        }
        if(BRI_1.equals("null")){
    ...
    @Test
    public void F7_DialOut_e1() throws InterruptedException {
        if (PRODUCT.equals(CLOUD_PBX) || PRODUCT.equals(PC)){
            return;
        }
        if(E1.equals("null")){
...
//    GSM呼出
    @Test
    public void F8_DialOut_gsm() throws InterruptedException {
        if (PRODUCT.equals(CLOUD_PBX) || PRODUCT.equals(PC)){
            return;
        }
        if(E1.equals("null")){
        ...
        YsAssert.assertEquals(getExtensionStatus(2000,RING,60),RING,"预期2000为Ring状态");
        pjsip.Pj_Answer_Call(2000,false);
        ys_waitingTime(5000);
        pjsip.Pj_Hangup_All();
...
//    不启用Dial Outbound Routes时不能呼出
    @Test
    public void F9_DialOut_disable() throws InterruptedException {
        ...
        YsAssert.assertEquals(getExtensionStatus(1100,HUNGUP,20),HUNGUP,"预期1100为Hang up状态");
        pjsip.Pj_Hangup_All();
...
//    Dial to Check to Voicemail
    @Test
    public void G1_voicemail_enable() throws InterruptedException {
    ...
    @Test
    public void G2_voicemail_disable() throws InterruptedException {
