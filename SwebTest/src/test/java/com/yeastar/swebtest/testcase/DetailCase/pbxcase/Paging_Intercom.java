...
public class Paging_Intercom extends SwebDriver {
    ...
    @Test
    public void A1_InitIntercom() throws InterruptedException {
    ...
    @Test
    public void A2_InitPaging() throws InterruptedException {
    ...
    @Test
    public void B1_add_Paging6300() throws InterruptedException {
    ...
    @Test
    public void B2_add_AutoPag6301() throws InterruptedException {
    ...
    @Test
    public void B3_add_NewPage6302() throws InterruptedException {
    ...
    @Test
    public void B4_add_Paging6303() throws InterruptedException {
    ...
    @Test
    public void B5_Apply() throws InterruptedException {
        ys_apply();
    }

//    分机1000启用总是转移到6300
    @Test
    public void C1_callforward() throws InterruptedException {
...
//    Type：单双工---查看设备是否会打印,d--打印双工
    @Test
    public void D1_1way() throws InterruptedException {
    ...
    @Test
    public void D2_2way() throws InterruptedException {
        ...
        if(getExtensionStatus(1100,TALKING,10)==TALKING && getExtensionStatus(1101,TALKING,10)==TALKING && getExtensionStatus(1105,TALKING,10)==TALKING){
            ...
            YsAssert.fail(" 1100、1101、1105自动应答失败");
        }
        pjsip.Pj_Hangup_All();
...
//    *Answer
    @Test
    public void E1_EnableAnswer() throws InterruptedException {
    ...
    @Test
    public void E2_DisableAnswer() throws InterruptedException {
        ...
        if(getExtensionStatus(1100,TALKING,10)==TALKING && getExtensionStatus(1103,TALKING,10)==TALKING && getExtensionStatus(1105,TALKING,10)==TALKING){
            ...
            if(getExtensionStatus(1100,HUNGUP,10)==TALKING &&
                ...
                YsAssert.fail(" 1105按*Answer--预期1100、1103不会挂断通话");
            }
        }else{
            YsAssert.fail(" 1100、1103、1105自动应答失败");
        }
        pjsip.Pj_Hangup_All();
...
//    外线呼入到分机xx,follow me 到Paging
    @Test
    public void F1_followToPaging() throws InterruptedException {
...
//    对讲Intercom
    @Test
    public void G1_intercom() throws InterruptedException {
...
//    修改特征码
    @Test
    public void G2_EditFeatureCode() throws InterruptedException {
    ...
    @Test
    public void G3_newIntercom() throws InterruptedException {
...
//    删除
    @Test
    public void H_delete() throws InterruptedException {
        pageDeskTop.taskBar_Main.click();
        pageDeskTop.settingShortcut.click();
        settings.callFeatures_tree.click();
        paging_intercom.paging_Intercom.click();
...
//    恢复设置
    @Test
    public void I_Recovery() throws InterruptedException {
