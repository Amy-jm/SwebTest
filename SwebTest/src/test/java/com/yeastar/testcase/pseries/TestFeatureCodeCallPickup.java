...
public class TestFeatureCodeCallPickup extends TestCaseBaseNew {
    ...
    public void testFCCP03_GroupCallPickupPickup3()
    {
        ...
        softAssertPlus.assertThat(apiUtil.getCDRRecord(2)).as("[CDR校验] Time：" + DataUtils.getCurrentTime()).extracting("callFrom", "callTo", "status", "reason", "sourceTrunk", "destinationTrunk", "communicatonType")
                .contains(tuple(Extension_2000.toString(), Extension_1002.toString(), ANSWER.toString(), String.format("%s picked up %s , %s hung up",Extension_1002.toString(),Extension_1000.toString(),Extension_2000.toString()), SPS, "", INBOUND.toString()))
                .contains(tuple(Extension_2000.toString(), Extension_1000.toString(), NO_ANSWER.toString(), Extension_2000.toString()+" called "+Extension_1000.toString(),  SPS, "", INBOUND.toString()));
        softAssertPlus.assertAll();
    }
    ...
    public void testFCCP04_GroupCallPickupPickup4()
    {
        ...
        softAssertPlus.assertThat(apiUtil.getCDRRecord(1)).as("[CDR校验] Time：" + DataUtils.getCurrentTime()).extracting("callFrom", "callTo", "status", "reason", "sourceTrunk", "destinationTrunk", "communicatonType")
                .contains(tuple(Extension_2000.toString(), Extension_1000.toString(), ANSWER.toString(), Extension_2000.toString()+" hung up",  SPS, "", INBOUND.toString()));
        softAssertPlus.assertAll();
    }
    ...
    public void testFCCP05_GroupCallPickupPickup5()
    {
        ...
        softAssertPlus.assertThat(apiUtil.getCDRRecord(2)).as("[CDR校验] Time：" + DataUtils.getCurrentTime()).extracting("callFrom", "callTo", "status", "reason", "sourceTrunk", "destinationTrunk", "communicatonType")
                .contains(tuple(Extension_4000.toString(), Extension_1004.toString(), ANSWER.toString(), String.format("%s picked up %s , %s hung up",Extension_1004.toString(),RINGGROUP0_6300.toString(),Extension_4000.toString()), ACCOUNTTRUNK, "", INBOUND.toString()))
                .contains(tuple(Extension_4000.toString(), RINGGROUP0_6300.toString(), NO_ANSWER.toString(), RINGGROUP0_6300.toString()+" timed out, failover",  ACCOUNTTRUNK, "", INBOUND.toString()));
        softAssertPlus.assertAll();
    }
    ...
    public void testFCCP06_GroupCallPickupPickup6()
    {
        ...
        softAssertPlus.assertThat(apiUtil.getCDRRecord(2)).as("[CDR校验] Time：" + DataUtils.getCurrentTime()).extracting("callFrom", "callTo", "status", "reason", "sourceTrunk", "destinationTrunk", "communicatonType")
                .contains(tuple(Extension_3001.toString(), Extension_1002.toString(), ANSWER.toString(), String.format("%s picked up %s , %s hung up",Extension_1002.toString(), QUEUE0_6400.toString(),Extension_1001.toString()), SIPTrunk, "", INBOUND.toString()))
    ...
    public void testFCCP07_GroupCallPickupPickup7()
    {
        ...
        softAssertPlus.assertThat(apiUtil.getCDRRecord(3)).as("[CDR校验] Time：" + DataUtils.getCurrentTime()).extracting("callFrom", "callTo", "status", "reason", "sourceTrunk", "destinationTrunk", "communicatonType")
                .contains(tuple(Extension_2000.toString(), Extension_1001.toString(), ANSWER.toString(), String.format("%s picked up %s , %s hung up",Extension_1001.toString(),Extension_1000.toString(),Extension_1001.toString()), SPS, "", INBOUND.toString()))
                .contains(tuple(Extension_2000.toString(), Extension_1000.toString(), NO_ANSWER.toString(), "Call completed elsewhere",  SPS, "", INBOUND.toString()))
                .contains(tuple(Extension_2000.toString(), IVR0_6200.toString(), ANSWER.toString(), Extension_2000.toString()+" called Extension",  SPS, "", INBOUND.toString()));
        softAssertPlus.assertAll();
    }
    ...
    public void testFCCP15_ExtensionPickupPickup4() {
        ...
        assertStep("检查cdr");
        softAssertPlus.assertThat(apiUtil.getCDRRecord(2)).as("[CDR校验] Time：" + DataUtils.getCurrentTime()).extracting("callFrom", "callTo", "status", "reason", "sourceTrunk", "destinationTrunk", "communicatonType")
                .contains(tuple(Extension_2000.toString(), Extension_1003.toString(), ANSWER.toString(), String.format("%s picked up %s , %s hung up",Extension_1003.toString(),Extension_1000.toString(),Extension_2000.toString()), SPS, "", INBOUND.toString()))
                .contains(tuple(Extension_2000.toString(), Extension_1000.toString(), NO_ANSWER.toString(), Extension_2000.toString()+" called "+Extension_1000.toString(),  SPS, "", INBOUND.toString()));
        softAssertPlus.assertAll();
    }
    ...
    public void testFCCP16_ExtensionPickupPickup5() {
        ...
        softAssertPlus.assertThat(apiUtil.getCDRRecord(2)).as("[CDR校验] Time：" + DataUtils.getCurrentTime()).extracting("callFrom", "callTo", "status", "reason", "sourceTrunk", "destinationTrunk", "communicatonType")
                .contains(tuple(Extension_4000.toString(), Extension_1004.toString(), ANSWER.toString(), String.format("%s picked up %s , %s hung up",Extension_1004.toString(),Extension_1003.toString(),Extension_4000.toString()), ACCOUNTTRUNK, "", INBOUND.toString()))
                .contains(tuple(Extension_4000.toString(), RINGGROUP0_6300.toString(), NO_ANSWER.toString(), RINGGROUP0_6300.toString()+" timed out, failover",  ACCOUNTTRUNK, "", INBOUND.toString()));
        softAssertPlus.assertAll();
    }
