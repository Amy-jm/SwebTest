...
public class TestOperatorQueue_2 extends TestCaseBase {
    ...
    public void testQueueIncomingTalkingStatus() {
        ...
        softAssertPlus.assertThat(resultSum).extracting("caller","callee","status","details")
                .contains(tuple(queueListName+":2000 [2000]","1001 B [1001]",op_talking, RECORD_DETAILS.EXTERNAL_QUEUE.getAlias()));
    ...
    public void testQueueIncomingTalkingRightClickPark() {
        ...
        List<Record> resultSum = auto.operatorPanelPage().getAllRecord(TABLE_TYPE.INBOUND);
        softAssertPlus.assertThat(resultSum).extracting("caller","callee","status","details")
                .contains(tuple(queueListName+":2000 [2000]","[6000]",op_talking, RECORD_DETAILS.EXTERNAL_PARKED.getAlias()));
    ...
    public void testQueueIncomingTalkingRightClickParkToUnPark() {
        ...
        List<Record> resultSum = auto.operatorPanelPage().getAllRecord(TABLE_TYPE.INBOUND);
        softAssertPlus.assertThat(resultSum).extracting("caller","callee","status","details")
                .contains(tuple(queueListName+":2000 [2000]","0 [0]",op_talking, RECORD_DETAILS.EXTERNAL.getAlias()));
    ...
    public void testQueueIncomingTalkingRightClickTransferToRingGroup() {
        ...
        softAssertPlus.assertThat(resultSum).extracting("caller","callee","status","details")
                .contains(tuple(ringGroupName2+":2000 [2000]","1005 E [1005]",op_ringing, RECORD_DETAILS.EXTERNAL_RING_GROUP.getAlias()));
    ...
    public void testQueueIncomingTalkingRightClickTransferToQueue() {
        ...
        softAssertPlus.assertThat(resultSum).extracting("caller","callee","status","details")
                .contains(tuple(queueListName2+":2000 [2000]","1004 E [1004]",op_ringing, RECORD_DETAILS.EXTERNAL_AGENT_RING.getAlias()),
                          tuple(queueListName2+":2000 [2000]","1005 E [1005]",op_ringing, RECORD_DETAILS.EXTERNAL_AGENT_RING.getAlias()));
    ...
    public void testQueueIncomingTalkingRightClickTransferToVoicemail() {
        ...
        List<Record> resultSum = auto.operatorPanelPage().getAllRecord(TABLE_TYPE.INBOUND);
        softAssertPlus.assertThat(resultSum).extracting("caller","callee","status","details")
                .contains(tuple(queueListName+":2000 [2000]","1004 E [1004]",op_ringing, RECORD_DETAILS.EXTERNAL.getAlias()));
        ...
        resultSum = auto.operatorPanelPage().getAllRecord(TABLE_TYPE.INBOUND);
        softAssertPlus.assertThat(resultSum).extracting("caller","callee","status","details")
                .contains(tuple(queueListName+":2000 [2000]","1004 E [1004]",op_talking, RECORD_DETAILS.EXTERNAL_VOICEMAIL.getAlias()));
    ...
    public void testQueueIncomingTalkingRightClickTransferToIVR() {
        ...
        List<Record> resultSum = auto.operatorPanelPage().getAllRecord(TABLE_TYPE.INBOUND);
        softAssertPlus.assertThat(resultSum).extracting("caller","callee","status","details")
                .contains(tuple(queueListName+":2000 [2000]",ivrName2+" [6201]",op_talking, RECORD_DETAILS.EXTERNAL_IVR.getAlias()));
    ...
    public void testQueueIncomingTalkingRightClickTransferToConference() {
        ...
        List<Record> resultSum = auto.operatorPanelPage().getAllRecord(TABLE_TYPE.INBOUND);
        softAssertPlus.assertThat(resultSum).extracting("caller","callee","status","details")
                .contains(tuple(queueListName+":2000 [2000]",conferenceName2+" [6501]",op_talking, RECORD_DETAILS.EXTERNAL_CONFERENCE.getAlias()));
    ...
    public void testQueueIncomingTalkingRightClickTransferInternalAHangup() {
        ...
        resultSum = auto.operatorPanelPage().getAllRecord(TABLE_TYPE.INBOUND);
        softAssertPlus.assertThat(resultSum).extracting("caller","callee","status","details")
                .contains(tuple(queueListName+":2000 [2000]","1004 E [1004]",op_talking, RECORD_DETAILS.EXTERNAL.getAlias()));
    ...
    @TmsLink(value = "")
    @Issue("")
    @Test(groups = {"P0","VCP","OperatorPanel","testQueueIncomingTalkingCallerHangup","Regression","PSeries"})
    public void testQueueIncomingTalkingCallerHangup() {
        prerequisite();
    ...
    @TmsLink(value = "")
    @Issue("")
    @Test(groups = {"P0","VCP","OperatorPanel","testQueueIncomingTalkingCalleeHangup","Regression","PSeries"})
    public void testQueueIncomingTalkingCalleeHangup() {
        prerequisite();
    ...
    public void testQueueIncomingDragAndDropWithCTalking(){
        ...
        List<Record> resultSum = auto.operatorPanelPage().getAllRecord(TABLE_TYPE.INBOUND);
        softAssertPlus.assertThat(resultSum).extracting("caller","callee","status","details")
                .contains(tuple(queueListName+":2000 [2000]","1000 A [1000]",op_talking, RECORD_DETAILS.EXTERNAL_VOICEMAIL.getAlias()));
    ...
    public void testQueueIncomingDragAndDropWithCIdle(){
        ...
        List<Record> resultSum = auto.operatorPanelPage().getAllRecord(TABLE_TYPE.INBOUND);
        softAssertPlus.assertThat(resultSum).extracting("caller","callee","status","details")
                .contains(tuple(queueListName+":2000 [2000]","1000 A [1000]",op_ringing, RECORD_DETAILS.EXTERNAL.getAlias()));
        ...
        resultSum = auto.operatorPanelPage().getAllRecord(TABLE_TYPE.INBOUND);
        softAssertPlus.assertThat(resultSum).extracting("caller","callee","status","details")
                .contains(tuple(queueListName+":2000 [2000]","1000 A [1000]",op_talking, RECORD_DETAILS.EXTERNAL.getAlias()));
    ...
    public void testQueueIncomingDragAndDropWithCUnregistered(){
        ...
        step("6：[Inbound]1000 -->拖动到[Extension]1001");
        auto.operatorPanelPage().dragAndDrop(DOMAIN.INBOUND,"1001",DOMAIN.EXTENSION,"1000");
        sleep(WaitUntils.TALKING_WAIT*3);
    ...
    public void testQueueIncomingDragAndDropParking(){
        ...
        resultSum = auto.operatorPanelPage().getAllRecord(TABLE_TYPE.INBOUND);
        softAssertPlus.assertThat(resultSum).extracting("caller","callee","status","details")
                .contains(tuple(queueListName+":2000 [2000]","1001 B [1001]",op_talking, RECORD_DETAILS.EXTERNAL.getAlias()));
    ...
    public void testQueueIncomingDragAndDropParkingRightClickTransfer(){
        ...
        auto.operatorPanelPage().dragAndDrop(DOMAIN.INBOUND,"1000",DOMAIN.PARKING,"6000");
        ...
        auto.operatorPanelPage().rightTableAction(TABLE_TYPE.INBOUND, "2000",RIGHT_EVENT.TRANSFER,"1000");
        pjsip.Pj_Answer_Call(1000,false);

        resultSum = auto.operatorPanelPage().getAllRecord(TABLE_TYPE.INBOUND);
        softAssertPlus.assertThat(resultSum).extracting("caller","callee","status","details")
                .contains(tuple(queueListName+":2000 [2000]","1000 A [1000]",op_talking, RECORD_DETAILS.EXTERNAL_PARKED.getAlias()));
    ...
    public void testQueueIncomingDragAndDropParkingRightClickUnpark(){
        ...
        softAssertPlus.assertThat(resultSum).extracting("caller","callee","status","details")
                .contains(tuple(queueListName+":2000 [2000]","0 [0]",op_talking, RECORD_DETAILS.EXTERNAL_PARKED.getAlias()));
