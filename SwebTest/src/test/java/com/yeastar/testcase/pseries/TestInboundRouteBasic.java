...
//                    {"44", 4000, "4444", DEVICE_ASSIST_3,"4000<4000>",ACCOUNTTRUNK},
        ...
        if (methodName.contains("_09") || methodName.contains("_38")) {
            return new Object[][]{
                    //routePrefix（路由前缀） + caller（主叫） + callee（被叫） + device_assist（主叫所在的设置ip）+ cdrCaller(CDR caller显示) + trunk(路由)
                    {"44", 4000, "4444", DEVICE_ASSIST_3, CDRNAME.Account_6700,ACCOUNTTRUNK},
            };
        }
        ...
        if (methodName.contains("_15_16") || methodName.contains("_22_23") || methodName.contains("_29_30")) {
            return new Object[][]{
                    ...
                    {"44", 4000, "1000", DEVICE_ASSIST_3,CDRNAME.Account_6700,ACCOUNTTRUNK},
            };
        }
...
//    }
    ...
    public void testIRB_04_05_Basic(String routePrefix, int caller, String callee, String deviceAssist, String cdrCaller, String trunk){
        log.info("需要调试的");
        if(trunk.trim().equalsIgnoreCase("null")){
...
//        }
    ...
    @TmsLink(value = "")
    @Issue("")
    @Test(groups = {"PSeries", "P3", "Trunk","InboundRoute","HangUp"}, dataProvider = "routes")
    ...
    @TmsLink(value = "")
    @Issue("")
    @Test(groups = {"PSeries", "P3", "Trunk","InboundRoute","Voicemail"}, dataProvider = "routes")
...
//        }
    ...
    public void testIRB_48_Delete(){
        ...
        step("单条删除");
        auto.inboundRoute().deleDataByDeleImage("In1","Name").clickSaveAndApply();
