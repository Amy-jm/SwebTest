...
//    private String reqDataInbound = String.format("" +
//            "")
    ...
    @Story("外线号码A 呼入到")
    @Description("外线号码2000 呼入到--> Extension 呼入到分机1000-->分机10000 响铃中 -->接听 -->呼入状态：talking\n" +
    ...
    public void testIncomingTalkingStatus() {
        ...
        step("1:login PBX");
        auto.loginPage().loginWithExtension("0",EXTENSION_PASSWORD,"New"+LOGIN_PASSWORD);
