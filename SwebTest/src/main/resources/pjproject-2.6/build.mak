export PJDIR := /home/pjsip/pjproject-2.6
...
export CC_NAME := gcc
export TARGET_NAME := arm-elf-linux-gnu
export CROSS_COMPILE := arm-elf-linux-
export LINUX_POLL := select 
export SHLIB_SUFFIX := so

export prefix := /home/pjsip/pjproject-2.6/out
...
export APP_LDLIBS := $(PJSUA_LIB_LDLIB) \
	...
	$(APP_THIRD_PARTY_EXT)\
	$(PJLIB_LDLIB) \
	-lopus -lm -lrt -lpthread  -lasound -lv4l2
...
export PJ_INSTALL_DIR := /home/pjsip/pjproject-2.6/out
