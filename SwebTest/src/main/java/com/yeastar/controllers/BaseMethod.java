...
//                        account = getPjsip().getUserAccountInfo(username);
	...
	public void initTrunk(){
		...
		step("创建sipRegister,SPS1,SIP2(不可用)中继");
		apiUtil.deleteTrunk(SPS).deleteTrunk(SIPTrunk2).deleteTrunk(SIPTrunk).createSIPTrunk(reqDataCreateSPS_2).createSIPTrunk(reqDataCreateS_SIPTrunk).createSIPTrunk(reqDataCreateS_SIPTrunk2).apply();
	}
