package com.yeastar.linkustest.tools.ysassert;
...
/**
 * Created by GAGA on 2017/5/11.
 */
public class YsAssert extends org.testng.Assert {
    //    static final LoggerControler logger = LoggerControler.getLogger(YsAssert.class);
    final static Logger logger = LoggerFactory.getLogger(YsAssert.class);
...
//        Reporter.sendReport("link","Error: " + message, SCREENSHOT_PATH +filename);
    ...
    public static void assertStartWith(String content, String prefix ) {
        YsAssert.assertStartWith(content, prefix, null);
    }
    ...
    public static void assertEndWith(String content, String endfix) {
        YsAssert.assertEndWith(content, endfix, null);
    }
    ...
    public static void assertMatch(String matcher, String regex) {
        YsAssert.assertMatch(matcher, regex, null);
    }
    ...
    public static void assertNoMatch(String matcher, String regex) {
        YsAssert.assertNoMatch(matcher, regex, null);
    }
    ...
    public static void assertInclude(String content, String included) {
        YsAssert.assertInclude(content, included, null);
    }
}
