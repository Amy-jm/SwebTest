...
//            accounts.removeAll(accounts);
    ...
    //   //被叫方手动接听 默认 code =  200
    public int Pj_Answer_Call(String CalleeNum ,int code){
        return Pj_Answer_Call(Integer.parseInt(CalleeNum),code,false);
    }
...
//                    System.out.println("account aaaaaa "+accounts.get(i).username);
