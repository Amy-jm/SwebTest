...
//    30.7.0.X
    ...
    //    30.8.0.X
    public  int Record_EmergencyCall_308 = 11;//设备未装linkus的情况下，如果有装linkus，要往后移两行
//    CloudPBX
...
//    30.6.0.X
    public int Notification_EmergencyCall_306 = 8;
//    30.7.0.X
    public int Notification_EmergencyCall_307 = 9; //设备未装linkus的情况下，如果有装linkus，要往后移两行
    //    30.8.0.X
    public int Notification_EmergencyCall_308 = 11;//设备未装linkus的情况下，如果有装linkus，要往后移两行
