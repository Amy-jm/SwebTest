...
public class EventLog {
    ...
    public String grid_Mask = "Ext.getCmp('control-panel').down('eventlog').down('loadmask')";
    ...
    public String eventType = ("st-el-eventtype");
    public String eventName = ("st-el-eventname");
    ...
    public SelenideElement go = $(By.xpath(".//div[starts-with(@id,\"eventlog\")]//span[ text()=\"Go\"]"));
