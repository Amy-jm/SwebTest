...
public class ConnectToSSH {
    ...
    public StringBuilder WriteToSSH(String cmd) {
...
//
//            while ((a =in.read()) != -1){
//                System.out.println("in..."+a+(char)a);
//
//            }
...
//            }
            while(true){
                System.out.println("err before readline");
    ...
    public  void testT(){
        ...
        int creatconnect =CreatConnect("192.168.7.151","ls@yf","");
...
//        System.out.println(WriteToSSH("/bin/asterisk -vvvvvvvvr"));
        Close();
    }
}
